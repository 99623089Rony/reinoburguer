...
export const CustomerBottomNav: React.FC<CustomerBottomNavProps> = ({ activeTab, onTabChange, cartCount }) => {
    return (
        <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 py-2 flex justify-between items-center z-50 max-w-md mx-auto">
            ...
            <button onClick={() => onTabChange('orders')} className={`flex flex-col items-center gap-1 ${activeTab === 'orders' ? 'text-orange-500' : 'text-gray-400'}`}>
